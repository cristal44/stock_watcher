...
public class ListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<StockSymbol> arrayList;

    public ListViewAdapter(Context context, List<StockSymbol> list) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StockSymbol stockSymbol = list.get(position);
                Intent intent = new Intent(context, MainActivity.class);
                intent.putExtra("SELECTEDSYMBOL", stockSymbol.getSymbol());
    ...
    public void filter(String charText){
        ...
        if (charText.length() == 0){
            ...
            for (StockSymbol name : arrayList){
